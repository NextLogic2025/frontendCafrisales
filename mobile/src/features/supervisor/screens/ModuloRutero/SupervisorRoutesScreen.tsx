...
export function SupervisorRoutesScreen() {
  ...
  const menuActions = [
    {
      label: 'Nuevo rutero logístico',
      icon: 'add-circle-outline' as const,
      onPress: () => navigation.navigate('SupervisorRuteroForm', { rutero: null }),
    },
    {
      label: 'Actualizar',
      ...
      <View className="flex-1">
        <GenericList
          ...
          emptyState={{
            ...
            title: 'Sin ruteros',
            message: 'Crea ruteros para planificar entregas.',
          }}
          renderItem={(route) => {
            ...
            return (
              <Pressable
                onPress={() => navigation.navigate('SupervisorRuteroDetalle', { ruteroId: route.id })}
