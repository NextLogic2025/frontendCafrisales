...
export function SupervisorCreditRequestDetailScreen() {
  ...
  if (loading) {
    return (
      <View className="flex-1 bg-neutral-50">
        <Header title="Solicitud de credito" variant="standard" onBackPress={() => navigation.goBack()} rightElement={<SupervisorHeaderMenu />} />
