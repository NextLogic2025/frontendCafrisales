...
import { ActivityIndicator, Image, Linking, RefreshControl, ScrollView, Text, TouchableOpacity, View } from 'react-native'
...
export function SellerClientDetailScreen() {
  ...
  const [client, setClient] = React.useState<UserClient | null>(clientParam || null)
    ...
    return (
      <View className="flex-1 bg-neutral-50">
        ...
        <View className="flex-1 items-center justify-center px-6">
          ...
          <Text className="text-lg font-bold text-neutral-900 text-center mb-2">Cliente no encontrado</Text>
          <Text className="text-neutral-500 text-center">No se pudo cargar la informacion del cliente</Text>
        </View>
      </View>
    )
  }
          ...
          {coordinatesReady ? (
            <View className="mt-4">
              ...
              <MiniMapPreview
                ...
                onPress={() => openInGoogleMaps(client.latitud as number, client.longitud as number)}
              />
              <TouchableOpacity
                onPress={() => openInGoogleMaps(client.latitud as number, client.longitud as number)}
