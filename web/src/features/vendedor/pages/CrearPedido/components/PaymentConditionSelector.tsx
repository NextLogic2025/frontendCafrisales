...
}: Omit<PaymentConditionSelectorProps, 'superaCredito'>) {
    return (
        <div className="rounded-2xl border border-neutral-200 px-3 py-3">
            ...
            <div className="space-y-2">
                ...
                <label className={`flex cursor-pointer items-center gap-2 rounded-xl border px-3 py-2 text-sm ${condicionPagoManual === 'CREDITO' ? 'border-brand-red/50 bg-brand-red/5' : 'border-neutral-200 hover:border-neutral-300'}`}>
                    <input
                        type="radio"
                        name="condicionPago"
                        value="CREDITO"
