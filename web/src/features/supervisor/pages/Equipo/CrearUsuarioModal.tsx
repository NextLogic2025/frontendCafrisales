...
import { createUsuario, type Usuario } from '../../services/usuariosApi'
...
const schema = z.object({
  role: z.enum(['vendedor', 'bodeguero', 'transportista']),
...
export function CrearUsuarioModal({ isOpen, onClose, onSuccess, mode = 'create' }: Props) {
  ...
  const onSubmit = handleSubmit(async (values) => {
    ...
    try {
      ...
      const fullCode = `EMPL-${values.empCode}`
  ...
  // Reset/Effect handling could be improved for edit mode, but focusing on Create as requested.
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="grid gap-1.5">
            ...
            <div className="flex items-center rounded-xl bg-neutral-50 px-3 ring-1 ring-neutral-200 focus-within:ring-2 focus-within:ring-brand-red transition-all">
              <span className="text-neutral-500 select-none font-medium">EMPL-</span>
              <input
                {...register('empCode')}
