                        ...
                        <div className="space-y-3">
                            ...
                            {skus.map((sku: any) => (
                                <button
                                    ...
                                    className="w-full flex items-center justify-between p-4 rounded-xl border-2 border-neutral-100 hover:border-brand-red hover:bg-red-50/50 transition-all group text-left"
                                >
                                    <div className="flex flex-col">
                                        <span className="font-bold text-neutral-900 group-hover:text-brand-red">
